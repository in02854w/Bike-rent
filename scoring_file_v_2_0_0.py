...
data_sample = PandasParameterType(pd.DataFrame({"day": pd.Series([0], dtype="int8"), "mnth": pd.Series([0], dtype="int8"), "year": pd.Series([0], dtype="int16"), "season": pd.Series([0], dtype="int8"), "holiday": pd.Series([0], dtype="int8"), "weekday": pd.Series([0], dtype="int8"), "workingday": pd.Series([0], dtype="int8"), "weathersit": pd.Series([0], dtype="int8"), "temp": pd.Series([0.0], dtype="float32"), "atemp": pd.Series([0.0], dtype="float32"), "hum": pd.Series([0.0], dtype="float32"), "windspeed": pd.Series([0.0], dtype="float32")}))
